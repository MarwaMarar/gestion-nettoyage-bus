...
public class GlobalExceptionHandler {
 ...
 @ExceptionHandler(AccessDeniedException.class) ResponseEntity<?> forbidden(Exception e,HttpServletRequest r){return body(HttpStatus.FORBIDDEN,e.getMessage(),r);}
